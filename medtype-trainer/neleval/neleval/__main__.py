...
def main(args=sys.argv[1:]):
	p = argparse.ArgumentParser(prog='neleval', description='Evaluation tools for Named Entity Linking output.')
	p.add_argument('--verbose', dest='log_level', action='store_const', const=logging.DEBUG, default=logging.INFO)
	p.add_argument('--quiet', dest='log_level', action='store_const', const=logging.ERROR)
	sp = p.add_subparsers()
	subparsers = {}
	for cls in APPS:
